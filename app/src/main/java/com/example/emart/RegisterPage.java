...
public class RegisterPage extends AppCompatActivity {
    ...
    public void reg(){
        ...
        if(TextUtils.isEmpty(name)){
            ...
            System.out.println("id: "+memberReg.id);
            System.out.println("Username: "+memberReg.username);
            System.out.println("Password: "+memberReg.password);
            System.out.println("Phone: "+memberReg.phone);
