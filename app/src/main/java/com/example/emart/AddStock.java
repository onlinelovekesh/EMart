                    ...
                    databaseStocks.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            for(DataSnapshot stockSnapshot:dataSnapshot.getChildren()){
                                ...
                                System.out.println("id : "+ id +" item id: "+ itemId + "Stock name: "+stockReg.itemName); // getting item id
                                ...
                                if(id==Integer.valueOf(String.valueOf(itemId.getText()))){
                                    ...
                                    System.out.println("curr : "+ curr); // getting current stock

                                    databaseStocks.child(stockReg.getId()).child("currentStockAvailable").setValue(curr);
                                    tmp=1;
                                    showSuccess();
